    ...
    function html5Upload() {	
    	...
    	sUploadURL= location.protocol + '//' + location.host + '/editMultiImageUpload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        sCallback : '/resources/edit/photo/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
