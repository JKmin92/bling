    ...
    <section class="inqury">
        ...
        <div class="form_table">
            <div class="table_tr">
                ...
                <div class="table_td"><input type="text" name="subject" /></div>
            </div>
            <div class="table_tr">
                <div class="table_td">성함</div>
                <div class="table_td"><input type="text" name="name" /></div>
            </div>
            <div class="table_tr">
                <div class="table_td">연락처</div>
                <div class="table_td"><input type="tel" name="phone" /></div>
            </div>
            <div class="table_tr">
                <div class="table_td">이메일</div>
                <div class="table_td"><input type="email" name="email" /></div>
            </div>
            <div class="table_tr">
